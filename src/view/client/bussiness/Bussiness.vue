<template>
  <div class="p-5">
    <router-link to="/bussiness/add-form" class="bg-indigo-900 hover:bg-blue-900 cursor-pointer p-10 text-cenger flex justify-center items-center rounded text-white">
